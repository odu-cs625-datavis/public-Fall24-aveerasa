...
**Due:** Wednesday, January 17, 2024 by 11:59pm  
...
* Open our public class repository, <https://github.com/odu-cs625-datavis/public-Spring24-aveerasa/>
...
To include an image in your report, you'll first need to [upload the image file to your repo](https://docs.github.com/en/repositories/working-with-files/managing-files/adding-a-file-to-a-repository). (When uploading files to GitHub, make sure that the filenames do not contain any spaces.) Let's assume that you have an image named `myHouse.png`, and you've uploaded it to your GitHub repo in the same directory as your report Markdown file.

The syntax for displaying an image is:  
`![alt text](path_to_image)`

For the image in the same directory as your report, you can use  
`![This is a picture of my House.](myHouse.png)`  
where "This is a picture of my House." will be the alt text (used for accessibility) and `myHouse.png` is the filename to be displayed.
...
For this assignment, go through the [Get Started with Tableau Desktop tutorial](https://help.tableau.com/current/guides/get-started-tutorial/en-us/get-started-tutorial-home.htm) through [Step 3: Focus your results](https://help.tableau.com/current/guides/get-started-tutorial/en-us/get-started-tutorial-focus.htm). In addition, watch the YouTube video to proceed further. (https://www.youtube.com/watch?v=x76lsCtCoZg)

#### Items for Report

Clone the file <UScitypopulation.xlsx> from my repository and connect that to Tableau to design a horizontal bar chart. Your bar chart should display the top 10 populated states in USA. Save the chart as an image (*don't just take a screenshot*). Save the image file in your repo (*no spaces in the filename*) and include the image in your `HW1-report.md`.  
